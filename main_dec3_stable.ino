...
// ========================================================
// Timing Parameters (CRITICAL FIX)
// ========================================================
#define SENSOR_INTERVAL       30000UL   // 30 s
#define RX_TIMEOUT            2000      // 2000ms for SF9 (SF9 symbol time ~1.024ms)
...
// ========================================================
// Loop - CRITICAL FIX: startReceive() called ALWAYS
// ========================================================
void loop() {
  feedWatchdog();
  handleButtonPress();
  ...
  // ===== CRITICAL FIX #1: ALWAYS restart RX =====
  // This fixes neighbor discovery and continuous reception
  radio.startReceive();
